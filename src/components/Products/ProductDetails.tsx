...
//     originalPrice : 1650,
//     price:1500,
//     description:"Designed for every moment — your go-to stylish bag",
//     brand:"Luxury Brand",
//     material:"Leather",
//     sizes:["S" , "M" , "L"],
...
//              altText:"Shoulder Bag 1"
//         }, 
//         { url: "https://picsum.photos/500/500?random=2" ,
//              altText:"Shoulder Bag 2"
//         },
    
//     ]
// }

// const similorProducts = [
//     {
//         _id:1,
//         name:"Product 1",
//         price:1500,
...
//                     Discover More Bags
//                 </h2>
//                 <ProductGrid products={similorProducts}/>
//             </div>
//         </div>
//     </div>
//   )
...
const selectedProduct = {
  ...
  colors: ["Black", "Brown", "White"],
  image: [
    { url: "https://picsum.photos/500/500?random=1", altText: "Shoulder Bag 1" },
    { url: "https://picsum.photos/500/500?random=2", altText: "Shoulder Bag 2" },
  ]
};
  ...
  return (
    <div className='p-6'>
      <div className='max-w-6xl mx-auto bg-white p-8 rounded-lg'>
        ...
        <div className='mt-20'>
          <h2 className='text-2xl text-center font-medium mb-4'>Discover More Bags</h2>
